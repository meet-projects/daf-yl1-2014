...
class Button(object):
	def __init__(self,screenBG, locationX, locationY, width = 100, height = 100, text = "", color = (0,0,0)):
	...
	def draw(self):
		...
		main_screen.blit(scoretext, (self.locationX + (self.width / 2) , self.locationY + (self.height / 2)))
...
if (__name__ == "__main__"):
	...
	button = Button(background_color, 100, 100, 150, 100, "Hello", (255,255,255))
	button.draw()
	while True: 
